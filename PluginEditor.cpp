    ...
    : AudioProcessorEditor (&p), audioProcessor (p),thumbnail(512, audioProcessor.formatManager, thumbnailCache)
{
    ...
    juce::File imageFile("/Users/nellygarcia/Downloads/NemisindoPlugIns/QAP/Irhedoki.png");
...
void QAPAudioProcessorEditor::paint (juce::Graphics& g)
{
    ...
    g.setFont(juce::Font("StencilStd", 30.0f, juce::Font::bold));
    g.drawText("QuAP", 0, 0, getWidth(), 50, juce::Justification::centred);
    if (Logo.isValid())
        {
